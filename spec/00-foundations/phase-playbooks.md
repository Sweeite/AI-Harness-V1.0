...
**Status (2026-07-01):** 13 of 14 built — `surface-00-auth.md`, `surface-01-config-admin.md`,
...
`surface-11-memory-nav.md`, `surface-12-mobile.md` ✅ signed off.
The remaining 1 (`surface-01b`) is **listed but not yet built**; surface-01's "View audit log →" link targets `surface-01b`,
