...
**Status (2026-06-30):** 4 of 14 built — `surface-00-auth.md`, `surface-01-config-admin.md`,
`surface-02-user-mgmt.md`, `surface-03-ingestion-queue.md` ✅ signed off.
The other 10 (incl. `surface-01b`) are **listed but not yet built**; surface-01's "View audit log →" link targets `surface-01b`,
