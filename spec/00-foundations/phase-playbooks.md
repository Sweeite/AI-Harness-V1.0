...
**Status (2026-07-01):** 8 of 14 built — `surface-00-auth.md`, `surface-01-config-admin.md`,
`surface-02-user-mgmt.md`, `surface-03-ingestion-queue.md`, `surface-04-approval-queue.md`,
`surface-05-dashboard-ops.md`, `surface-06-dashboard-super-admin.md`, `surface-07-dashboard-agency.md` ✅ signed off.
The other 6 (incl. `surface-01b`) are **listed but not yet built**; surface-01's "View audit log →" link targets `surface-01b`,
