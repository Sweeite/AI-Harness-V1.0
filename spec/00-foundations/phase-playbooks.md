...
**Status (2026-07-01):** 11 of 14 built — `surface-00-auth.md`, `surface-01-config-admin.md`,
...
`surface-08-dashboard-user.md`, `surface-09-agent-builder.md`, `surface-10-commands.md` ✅ signed off.
The other 3 (incl. `surface-01b`) are **listed but not yet built**; surface-01's "View audit log →" link targets `surface-01b`,
