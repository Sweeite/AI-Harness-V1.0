...
**Status (2026-07-01):** 12 of 14 built — `surface-00-auth.md`, `surface-01-config-admin.md`,
...
`surface-11-memory-nav.md` ✅ signed off.
The other 2 (incl. `surface-01b`) are **listed but not yet built**; surface-01's "View audit log →" link targets `surface-01b`,
