...
| ISSUE-004 🔵 **in-progress** | SPIKE: restore actually works (DB+pgvector+auth) — harness built `spikes/issue-004-restore-rehearsal/`, **not yet run** (R8 you-present; needs operator infra). AF-069 🔴 | NFR-DR.003, AF-069 | none | AF-069 |
| ISSUE-005 🔵 **in-progress** | SPIKE: brute-force / credential defense — harness built `spikes/issue-005-brute-force-defense/`, **not yet run** (R8 you-present; needs throwaway Auth project + seeded account). AF-077 🔴 | NFR-SEC.009, AF-077 | none | AF-077 |
| ISSUE-006 🔵 **in-progress** | SPIKE: webhook forgery / replay rejected — harness built `spikes/issue-006-webhook-forgery/` (MODE M mechanics + MODE R real), **not yet run** (R8 you-present; MODE R needs live GHL payload + public key → AF-090). AF-078 🔴 | NFR-SEC.008, AF-078 | none | AF-078 |
...
- **Tier 0 (spikes, run first / alongside):** ~~001~~ ✅ · ~~002~~ ✅ · ~~003~~ ✅ · 🔵 004 · 🔵 005 · 🔵 006 — gate their dependents; none blocks another. (001 done 2026-07-03 — AF-001 PASS. 002 done 2026-07-04 — AF-067 PASS; surfaced AF-019 planner cliff → ISSUE-023. 003 done 2026-07-04 — AF-068 PASS; containment red-team, 12/12 attacks contained + mutation-tested. **004/005/006 in-progress 2026-07-04 (Session 54): runnable harnesses built + reviewed + typecheck, but NOT run — all three are R8 "you-present" gates that need the operator's real infra/credentials; AF-069/077/078 stay 🔴; Checkpoint 0 stays open. 007 GATE also still owed.**)
