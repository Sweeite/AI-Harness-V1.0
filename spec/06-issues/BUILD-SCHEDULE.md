...
they'd both grab `0003` and collide on `_journal.json`. **Applied-LIVE head: `0046_memory_erasure_event_types` (session 87, ISSUE-029 close). Next free silo tag is `0047`.**
