...
they'd both grab `0003` and collide on `_journal.json`. **Applied-LIVE head: `0043_learning_cost_event_types` (session 85, Stage-7 batch `026`/`027`/`066` close). Next free silo tag is `0044`.**
