...
| 1 — Requirements | 🟡 in progress — **component 0 (Login) ✅ Approved 2026-06-24** (42 FRs + 1 retired; OD-012…OD-023 resolved; verification gate clean; matrix + system-map wired). **Next: component 1 (RBAC).** |
